...
public class IotHubReactorTest
{
    ...
    @Test
    public void constructorSuccessWithSasl()
    {
        //act
        IotHubReactor iotHubReactor = Deencapsulation.newInstance(IotHubReactor.class, new Class[] {Reactor.class, boolean.class}, mockReactor, true);
