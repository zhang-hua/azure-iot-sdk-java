...
public class SendMessagesIT
{
    ...
    @Test
    public void sendMessagesOverAmqpsWSWithX509() throws IOException, URISyntaxException, InterruptedException
    {
        DeviceClient client = new DeviceClient(DeviceConnectionString.get(iotHubConnectionString, deviceAmqpsX509), IotHubClientProtocol.AMQPS_WS, publicKeyCert, false, privateKey, false);
        client.open();
        sendMessages(client, IotHubClientProtocol.AMQPS, NUM_MESSAGES_PER_CONNECTION, RETRY_MILLISECONDS, SEND_TIMEOUT_MILLISECONDS);
        client.closeNow();
    }
