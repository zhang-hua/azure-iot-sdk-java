...
public class SendMessagesIT
{
    ...
    public void tokenExpiredAfterOpenButBeforeSendHTTPS() throws InvalidKeyException, IOException, InterruptedException, URISyntaxException
    {
        ...
        SendMessagesCommon.sendMessagesExpectingSASTokenExpiration(client, IotHubClientProtocol.HTTPS.toString(), true, NUM_MESSAGES_PER_CONNECTION, RETRY_MILLISECONDS, SEND_TIMEOUT_MILLISECONDS);
        client.closeNow();
    }
    ...
    public void tokenExpiredAfterOpenButBeforeSendMqtt() throws InvalidKeyException, IOException, InterruptedException, URISyntaxException
    {
        ...
        //Force the SAS token to expire before sending messages
        Thread.sleep(MILLISECONDS_TO_WAIT_FOR_TOKEN_TO_EXPIRE);
        SendMessagesCommon.sendMessagesExpectingSASTokenExpiration(client, IotHubClientProtocol.MQTT.toString(), false, NUM_MESSAGES_PER_CONNECTION, RETRY_MILLISECONDS, SEND_TIMEOUT_MILLISECONDS);
        client.closeNow();
    }
    ...
    public void tokenExpiredAfterOpenButBeforeSendMqttWs() throws InvalidKeyException, IOException, InterruptedException, URISyntaxException
    {
        ...
        //Force the SAS token to expire before sending messages
        Thread.sleep(MILLISECONDS_TO_WAIT_FOR_TOKEN_TO_EXPIRE);
        SendMessagesCommon.sendMessagesExpectingSASTokenExpiration(client, IotHubClientProtocol.MQTT_WS.toString(), false, NUM_MESSAGES_PER_CONNECTION, RETRY_MILLISECONDS, SEND_TIMEOUT_MILLISECONDS);
        client.closeNow();
    }
    ...
    public void tokenExpiredAfterOpenButBeforeSendAmqps() throws InvalidKeyException, IOException, InterruptedException, URISyntaxException
    {
        ...
        //Force the SAS token to expire before sending messages
        Thread.sleep(MILLISECONDS_TO_WAIT_FOR_TOKEN_TO_EXPIRE);
        SendMessagesCommon.sendMessagesExpectingSASTokenExpiration(client, IotHubClientProtocol.AMQPS.toString(), true, NUM_MESSAGES_PER_CONNECTION, RETRY_MILLISECONDS, SEND_TIMEOUT_MILLISECONDS);
        client.closeNow();
    }
    ...
    public void tokenExpiredAfterOpenButBeforeSendAmqpsWS() throws InvalidKeyException, IOException, InterruptedException, URISyntaxException
    {
        ...
        //Force the SAS token to expire before sending messages
        Thread.sleep(MILLISECONDS_TO_WAIT_FOR_TOKEN_TO_EXPIRE);
        SendMessagesCommon.sendMessagesExpectingSASTokenExpiration(client, IotHubClientProtocol.AMQPS_WS.toString(), true, NUM_MESSAGES_PER_CONNECTION, RETRY_MILLISECONDS, SEND_TIMEOUT_MILLISECONDS);
        client.closeNow();
    }
}